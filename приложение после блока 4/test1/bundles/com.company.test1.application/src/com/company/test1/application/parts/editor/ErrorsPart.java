...
import com.company.test1.application.utils.validation.ErrorType;
import com.company.test1.application.utils.validation.ObjectType;
import com.company.test1.application.utils.validation.Problem;
...
public class ErrorsPart {
	...
	private class ErrorTreeObjTypeItem extends ErrorTreeItem {
		...
		public Image getImage() {
			return objectType.getTreeElementType().getIcon();
		}
	}
