...
public enum TreeElementType {
	...
	CHANGEOVER(IconsMapping.PERFORMANCE_RECORD, "Changeovers"),
	OPERATION_ASSIGNMENT(IconsMapping.PERFORMANCE_RECORD, "Operation assignments"),
	UNAVAILABILITY_ASSIGNMENT(IconsMapping.PERFORMANCE_RECORD, "Unavailabilities")
	;
