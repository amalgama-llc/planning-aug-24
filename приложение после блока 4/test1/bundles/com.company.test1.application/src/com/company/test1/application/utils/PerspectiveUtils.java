...
public class PerspectiveUtils {
	 ...
	 */
	public static final String COMMAND_PARAMETER_NAME = "com.company.test1.application.commandparameter.switchPerspective";
	
	public static final String MODE_MENU_ID = "com.company.test1.application.menu.mode";
	
	private static final String PERSPECTIVE_STACK_ID = "com.company.test1.application.perspectivestack.0";
	...
	public enum Perspective {
		EDITOR("com.company.test1.application.perspective.editor", false, false),
		SCHEDULING("com.company.test1.application.perspective.scheduling", false, true),
		;
