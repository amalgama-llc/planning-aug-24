...
public class DatamodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected DatamodelSwitch<Adapter> modelSwitch = new DatamodelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseChangeover(Changeover object) {
			return createChangeoverAdapter();
		}
		...
		@Override
		public Adapter caseOperationAssignment(OperationAssignment object) {
			return createOperationAssignmentAdapter();
		}

		@Override
		public Adapter caseUnavailabilityAssignment(UnavailabilityAssignment object) {
			return createUnavailabilityAssignmentAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.company.test1.datamodel.Changeover <em>Changeover</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createChangeoverAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.company.test1.datamodel.Assignment <em>Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.company.test1.datamodel.OperationAssignment <em>Operation Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOperationAssignmentAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.company.test1.datamodel.UnavailabilityAssignment <em>Unavailability Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUnavailabilityAssignmentAdapter() {
		return null;
	}
