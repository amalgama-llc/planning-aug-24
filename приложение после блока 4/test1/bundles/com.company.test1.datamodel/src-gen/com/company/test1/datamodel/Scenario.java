 ...
 *   <li>{@link com.company.test1.datamodel.Scenario#getChangeovers <em>Changeovers</em>}</li>
 *   <li>{@link com.company.test1.datamodel.Scenario#getOperationAssignments <em>Operation Assignments</em>}</li>
 *   <li>{@link com.company.test1.datamodel.Scenario#getUnavailabilityAssignments <em>Unavailability Assignments</em>}</li>
 * </ul>
 *
...
public interface Scenario extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Changeovers</b></em>' containment reference list.
	 * The list contents are of type {@link com.company.test1.datamodel.Changeover}.
	 * It is bidirectional and its opposite is '{@link com.company.test1.datamodel.Changeover#getScenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Changeovers</em>' containment reference list.
	 * @see com.company.test1.datamodel.DatamodelPackage#getScenario_Changeovers()
	 * @see com.company.test1.datamodel.Changeover#getScenario
	 * @model opposite="scenario" containment="true"
	 * @generated
	 */
	EList<Changeover> getChangeovers();

	/**
	 * Returns the value of the '<em><b>Operation Assignments</b></em>' containment reference list.
	 * The list contents are of type {@link com.company.test1.datamodel.OperationAssignment}.
	 * It is bidirectional and its opposite is '{@link com.company.test1.datamodel.OperationAssignment#getScenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Operation Assignments</em>' containment reference list.
	 * @see com.company.test1.datamodel.DatamodelPackage#getScenario_OperationAssignments()
	 * @see com.company.test1.datamodel.OperationAssignment#getScenario
	 * @model opposite="scenario" containment="true"
	 * @generated
	 */
	EList<OperationAssignment> getOperationAssignments();

	/**
	 * Returns the value of the '<em><b>Unavailability Assignments</b></em>' containment reference list.
	 * The list contents are of type {@link com.company.test1.datamodel.UnavailabilityAssignment}.
	 * It is bidirectional and its opposite is '{@link com.company.test1.datamodel.UnavailabilityAssignment#getScenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Unavailability Assignments</em>' containment reference list.
	 * @see com.company.test1.datamodel.DatamodelPackage#getScenario_UnavailabilityAssignments()
	 * @see com.company.test1.datamodel.UnavailabilityAssignment#getScenario
	 * @model opposite="scenario" containment="true"
	 * @generated
	 */
	EList<UnavailabilityAssignment> getUnavailabilityAssignments();
