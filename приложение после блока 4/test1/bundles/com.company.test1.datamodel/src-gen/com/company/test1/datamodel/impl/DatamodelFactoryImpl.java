...
public class DatamodelFactoryImpl extends EFactoryImpl implements DatamodelFactory {
	...
	public EObject create(EClass eClass) {
		...
		case DatamodelPackage.CHANGEOVER:
			return createChangeover();
		case DatamodelPackage.OPERATION_ASSIGNMENT:
			return createOperationAssignment();
		case DatamodelPackage.UNAVAILABILITY_ASSIGNMENT:
			return createUnavailabilityAssignment();
		default:
	 ...
	 */
	@Override
	public Changeover createChangeover() {
		ChangeoverImpl changeover = new ChangeoverImpl();
		return changeover;
	}
	 ...
	 */
	@Override
	public OperationAssignment createOperationAssignment() {
		OperationAssignmentImpl operationAssignment = new OperationAssignmentImpl();
	 ...
	 */
	@Override
	public UnavailabilityAssignment createUnavailabilityAssignment() {
		UnavailabilityAssignmentImpl unavailabilityAssignment = new UnavailabilityAssignmentImpl();
		return unavailabilityAssignment;
	}
