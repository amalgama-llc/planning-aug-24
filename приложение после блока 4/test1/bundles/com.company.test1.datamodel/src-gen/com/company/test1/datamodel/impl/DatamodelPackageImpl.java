...
public class DatamodelPackageImpl extends EPackageImpl implements DatamodelPackage {
	 ...
	 * @generated
	 */
	private EClass changeoverEClass = null;
	 ...
	 * @generated
	 */
	private EClass operationAssignmentEClass = null;
	 ...
	 * @generated
	 */
	private EClass unavailabilityAssignmentEClass = null;
	 ...
	 */
	@Override
	public EReference getScenario_Changeovers() {
	 ...
	 */
	@Override
	public EReference getScenario_OperationAssignments() {
	 ...
	 */
	@Override
	public EReference getScenario_UnavailabilityAssignments() {
	 ...
	 */
	@Override
	public EClass getChangeover() {
		return changeoverEClass;
	}
	 ...
	 */
	@Override
	public EReference getChangeover_Scenario() {
		return (EReference) changeoverEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getChangeover_PrevOperation() {
		return (EReference) changeoverEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getChangeover_NextOperation() {
		return (EReference) changeoverEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getChangeover_WorkCenter() {
		return (EReference) changeoverEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getChangeover_DurationMinutes() {
		return (EAttribute) changeoverEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EAttribute getChangeover_Cost() {
		return (EAttribute) changeoverEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EReference getAssignment_WorkCenter() {
	 ...
	 */
	@Override
	public EAttribute getAssignment_BeginDate() {
	 ...
	 */
	@Override
	public EClass getOperationAssignment() {
		return operationAssignmentEClass;
	}
	 ...
	 */
	@Override
	public EReference getOperationAssignment_Scenario() {
		return (EReference) operationAssignmentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getOperationAssignment_Product() {
		return (EReference) operationAssignmentEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getOperationAssignment_ProductionPlanItemIndex() {
		return (EAttribute) operationAssignmentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getOperationAssignment_Operation() {
		return (EReference) operationAssignmentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getOperationAssignment_Cost() {
		return (EAttribute) operationAssignmentEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EClass getUnavailabilityAssignment() {
		return unavailabilityAssignmentEClass;
	}
	 ...
	 */
	@Override
	public EReference getUnavailabilityAssignment_Scenario() {
		return (EReference) unavailabilityAssignmentEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(scenarioEClass, SCENARIO__CHANGEOVERS);
		createEReference(scenarioEClass, SCENARIO__OPERATION_ASSIGNMENTS);
		createEReference(scenarioEClass, SCENARIO__UNAVAILABILITY_ASSIGNMENTS);
		...
		changeoverEClass = createEClass(CHANGEOVER);
		createEReference(changeoverEClass, CHANGEOVER__SCENARIO);
		createEReference(changeoverEClass, CHANGEOVER__PREV_OPERATION);
		createEReference(changeoverEClass, CHANGEOVER__NEXT_OPERATION);
		createEReference(changeoverEClass, CHANGEOVER__WORK_CENTER);
		createEAttribute(changeoverEClass, CHANGEOVER__DURATION_MINUTES);
		createEAttribute(changeoverEClass, CHANGEOVER__COST);

		assignmentEClass = createEClass(ASSIGNMENT);
		createEReference(assignmentEClass, ASSIGNMENT__WORK_CENTER);
		createEAttribute(assignmentEClass, ASSIGNMENT__BEGIN_DATE);
		createEAttribute(assignmentEClass, ASSIGNMENT__END_DATE);

		operationAssignmentEClass = createEClass(OPERATION_ASSIGNMENT);
		createEReference(operationAssignmentEClass, OPERATION_ASSIGNMENT__SCENARIO);
		createEReference(operationAssignmentEClass, OPERATION_ASSIGNMENT__PRODUCT);
		createEAttribute(operationAssignmentEClass, OPERATION_ASSIGNMENT__PRODUCTION_PLAN_ITEM_INDEX);
		createEReference(operationAssignmentEClass, OPERATION_ASSIGNMENT__OPERATION);
		createEAttribute(operationAssignmentEClass, OPERATION_ASSIGNMENT__COST);

		unavailabilityAssignmentEClass = createEClass(UNAVAILABILITY_ASSIGNMENT);
		createEReference(unavailabilityAssignmentEClass, UNAVAILABILITY_ASSIGNMENT__SCENARIO);
	...
	public void initializePackageContents() {
		...
		operationAssignmentEClass.getESuperTypes().add(this.getAssignment());
		unavailabilityAssignmentEClass.getESuperTypes().add(this.getAssignment());
		...
		initEReference(getScenario_PerformanceRecords(), this.getPerformanceRecord(),
				...
				IS_ORDERED);
		initEReference(getScenario_Changeovers(), this.getChangeover(), this.getChangeover_Scenario(), "changeovers",
				null, 0, -1, Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScenario_OperationAssignments(), this.getOperationAssignment(),
				this.getOperationAssignment_Scenario(), "operationAssignments", null, 0, -1, Scenario.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScenario_UnavailabilityAssignments(), this.getUnavailabilityAssignment(),
				this.getUnavailabilityAssignment_Scenario(), "unavailabilityAssignments", null, 0, -1, Scenario.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(changeoverEClass, Changeover.class, "Changeover", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getChangeover_Scenario(), this.getScenario(), this.getScenario_Changeovers(), "scenario", null,
				0, 1, Changeover.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChangeover_PrevOperation(), this.getOperation(), null, "prevOperation", null, 0, 1,
				Changeover.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChangeover_NextOperation(), this.getOperation(), null, "nextOperation", null, 0, 1,
				Changeover.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChangeover_WorkCenter(), this.getWorkCenter(), null, "workCenter", null, 0, 1,
				Changeover.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getChangeover_DurationMinutes(), ecorePackage.getEDouble(), "durationMinutes", null, 0, 1,
				Changeover.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getChangeover_Cost(), ecorePackage.getEDouble(), "cost", null, 0, 1, Changeover.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(assignmentEClass, Assignment.class, "Assignment", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAssignment_WorkCenter(), this.getWorkCenter(), null, "workCenter", null, 0, 1,
				Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssignment_BeginDate(), theEcoreutilsPackage.getLocalDateTime(), "beginDate", null, 0, 1,
				Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssignment_EndDate(), theEcoreutilsPackage.getLocalDateTime(), "endDate", null, 0, 1,
				Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(operationAssignmentEClass, OperationAssignment.class, "OperationAssignment", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOperationAssignment_Scenario(), this.getScenario(), this.getScenario_OperationAssignments(),
				"scenario", null, 0, 1, OperationAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationAssignment_Product(), this.getProduct(), null, "product", null, 0, 1,
				OperationAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationAssignment_ProductionPlanItemIndex(), ecorePackage.getEInt(),
				"productionPlanItemIndex", null, 0, 1, OperationAssignment.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperationAssignment_Operation(), this.getOperation(), null, "operation", null, 0, 1,
				OperationAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOperationAssignment_Cost(), ecorePackage.getEDouble(), "cost", null, 0, 1,
				OperationAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(unavailabilityAssignmentEClass, UnavailabilityAssignment.class, "UnavailabilityAssignment",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUnavailabilityAssignment_Scenario(), this.getScenario(),
				this.getScenario_UnavailabilityAssignments(), "scenario", null, 0, 1, UnavailabilityAssignment.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(selectorTypeEEnum, SelectorType.MAX_UTILIZATION);
		addEEnumLiteral(selectorTypeEEnum, SelectorType.CHEAPEST_20);
